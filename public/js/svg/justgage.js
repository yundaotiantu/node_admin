 ...
 * -----------------------------
 ...
 JustGage = function(config) {
  ...
  obj.config =
  {
    ...
    titleFontSize : kvLookup('titleFontSize', config, dataset, 13),

    // titleFontColor : string
    // color of gauge title
    titleFontColor : kvLookup('titleFontColor', config, dataset,  ""),
  ...
  if (obj.config.donut === true) {
    ...
    // title
    // titleFontSize = ((widgetH / 8) > 12) ? (widgetH / 10) : 12;
    titleX = dx + widgetW / 2;
  ...
  obj.params  = {
    ...
    dx : dx,
    dy : dy,
    titleFontSize : obj.config.titleFontSize,
    titleX : titleX,
    titleY : titleY,
  ...
  // var clear
  canvasW, canvasH, widgetW, widgetH, aspect, dx, dy, titleX, titleY, valueFontSize, valueX, valueY, labelFontSize, labelX, labelY, minFontSize, minX, minY, maxFontSize, maxX, maxY = null;
